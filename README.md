...
[![Status](https://img.shields.io/badge/Status-Stable_(v5.0.0)-green.svg)]()
...
graph TD
    ...
    LoadConfig --> PhaseSelect{Phase Selection?}
    ...
    subgraph "Phase 1: Deep Infrastructure"
        ...
        PortCheck --> ServiceCheck[Real DNS Query Validation]
